        ...
        <section className = "about-me">
            ...
            <div className = "about-me-text">
                <p>
                    ...
                    hospital Pharmacy to community practice and now software Engineering — I've 
                    never stopped engaging my passion when it comes to problem solving.
                </p>
                <p>
                    As a web developer, I enjoy using my obsessive attention to detail, my unequivocal 
